...
namespace adventure
{
    public class Map : Location
    {
        ...
        public Map()
            {
                //if (Options.MAP_SIZE < 1){}
                _gameMap = new Location [Options.MAP_SIZE,Options.MAP_SIZE];
            }
        ...
        public void Init()
            {
                ...
                _gameMap[3,3] = new Location("You hug the a Cave. The cave likes you. You hear a loud purr begin. \n" +
                                            "The joy from your hug causes the tunnel to collapse.\n \n" + 
                                            "-=Choices=- \n \n" +
                                            "You die, Please \"Exit\"\n \n");
                ...
                //A3 Requirement Pressure Decision or Puzzle
                _gameMap[2,5] = new Location("As you go down the tunnel, you reach a large stone door. \n" +
                                            "On the door a thousand faces are etched meticulously around the edge. \n" +
                                            "A small sign hangs on what appears to be a knob, on it the words \n" +
                                            "\"How many faces watch me?\"\n" +
                                            "-=Answer the Riddle=-\n \n");
                _gameMap[2,5].SetAllowableDirections( false, false, false, false);
                _gameMap[2,5].IsRiddle(true);
                
                _gameMap[2,6] = new Location("As you go down the tunnel, the screams intesify. A large bustling town \n" +
                ...
                _gameMap[2,6].SetAllowableDirections( false, false, false, false);
                                // UP, DOWN, LEFT, RIGHT
        ...
        public Location LocationAt (int i, int j)
            {
                if((i < Options.MAP_SIZE) || (j < Options.MAP_SIZE))
                    {
                    return (_gameMap[i,j]);
                    }
